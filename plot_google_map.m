...
% Adapted from https://www.mathworks.com/matlabcentral/fileexchange/27627-zoharby-plot-google-map
...
lat = center_coords(1);%43.7623;%(curAxis(3)+curAxis(4))/2;
lon = center_coords(2);%-69.3203;%(curAxis(1)+curAxis(2))/2;

% Construct query URL
preamble = 'http://maps.googleapis.com/maps/api/staticmap';
location = ['?center=' num2str(lat) ',' num2str(lon)];
